...
public:
    ...
    double delayInSeconds() const {return fDelayInSeconds;}
    double packetLossPercent() const {return fPacketLossPercent;}
...
private:
  ...
  u_int32_t fLastPacketCount, fTotalPacketCount_hi, fTotalPacketCount_lo;
    ...
    double fDelayInSeconds;
    double fPacketLossPercent;
};
